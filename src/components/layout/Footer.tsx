    ...
    <footer className="py-12 transition-colors duration-300 
      ...
      <div className="max-w-6xl px-6 mx-auto flex flex-col items-center gap-4">
        ...
        <p className="text-sm font-medium text-slate-500 dark:text-gray-400 text-center">
          © {currentYear} <span className="text-slate-900 dark:text-white">John Esteban Liévano</span>. 
          <br className="md:hidden" /> {t('footer.rights', 'Todos los derechos reservados.')}
        </p>
