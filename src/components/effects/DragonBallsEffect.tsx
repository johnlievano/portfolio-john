    ...
    return (
      <div className="relative w-64 h-64 md:w-[400px] md:h-[400px]">
        ...
        <div className="relative w-full h-full overflow-hidden border-4 shadow-2xl rounded-3xl border-white/80 dark:border-white/10 bg-white dark:bg-black/20">
          <picture>
            <source media="(max-width: 767px)" srcSet="/perfil_white-mobile.webp" />
            <img
              src={imgLight}
              srcSet={profileSrcSet}
              sizes="(min-width: 768px) 800px, 256px"
              alt={altLight}
              width={400}
              height={400}
              loading="eager"
          ...
          <picture>
            <source media="(max-width: 767px)" srcSet="/perfil_black-mobile.webp" />
            <img
              src={imgDark}
